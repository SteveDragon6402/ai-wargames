...
import type { Army, ArmyConditionUpdate, NpcRuntimePatch } from "@/app/got-houses-v2/types";
import { HOLDS_MAP } from "@/app/got-houses-v2/data/holds";
import { countWords, SPEECH_MAX_WORDS } from "@/app/got-houses-v2/data/characters";
