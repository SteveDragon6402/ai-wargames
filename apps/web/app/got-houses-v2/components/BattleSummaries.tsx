...
/** One line of the "what mattered" strip: the inputs behind the verdict. */
function FactorRow({ label, value }: { label: string; value: string }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ color: "#7a7a7a" }}>{value}</div>
    </div>
  );
}
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* What mattered — the inputs behind the verdict */}
          {report.factors && (
            <>
              <div>
                <div
                ...
                <FactorRow label="Numbers" value={report.factors.forceRatio} />
                <FactorRow label="Ground" value={report.factors.ground} />
                <FactorRow label="Country" value={report.factors.region} />
                <FactorRow label="North" value={report.factors.northPosture} />
          ...
          {report.fallbackReason && (
            <>
              ...
              >
                Settled without an adjudicator — numbers and posture only.
                <div style={{ color: "#6a5a3a", marginTop: 3 }}>{report.fallbackReason}</div>
              </div>
              <div style={{ borderTop: "1px solid #1a1a1a" }} />
            </>
          )}
