...
function SubmitButton({
  ...
  const blocked = !submitted && !!blockedBy;
  const label = locked
    ? "⚔ Battle in Progress"
    : submitted
    ? "Orders Locked ✓"
  ...
  return (
    <button
      ...
      onClick={onSubmit}
      title={blocked ? "A captured seat must be garrisoned first" : undefined}
      style={{
        fontFamily: "var(--font-mono), monospace",
        fontSize: 9,
        fontWeight: 700,
        ...
        border: submitted
          ...
          ? "1px solid #4a2010"
          : "1px solid #3a2a00",
        background: submitted ? "#0a1a0a" : blocked ? "#170a04" : "#1a1200",
        color: submitted ? "#5ecb6b" : blocked ? "#c06030" : "#c8941a",
