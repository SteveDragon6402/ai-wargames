...
export const INITIAL_GAME_STATE: GameState = {
  ...
  north: { orders: [], stanceOrders: {}, stormArmyIds: [], sallyHoldIds: [], razeOrders: [], submitted: false },
  westerlands: { orders: [], stanceOrders: {}, stormArmyIds: [], sallyHoldIds: [], razeOrders: [], submitted: false },
  adminMode: true,
  activeFaction: "north",
  pendingBattles: [],
  battleReports: [],
